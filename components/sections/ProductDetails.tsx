        ...
        <div className="grid gap-6 md:grid-cols-3">
          {[
            ...
            <AnimateIn key={i} delay={i * 0.08}>
              <div className="rounded-[3px] overflow-hidden bg-white">
      ...
      <Section tone="dark">
        <div className="grid gap-12 lg:gap-16 lg:grid-cols-2 items-start">
          <AnimateIn>
            ...
            />
            <div className="mt-8 rounded-[3px] overflow-hidden" style={{ border: '1px solid var(--border-soft)' }}>
              {SPECS.map((s, i) => (
          ...
          <AnimateIn delay={0.1}>
            <div className="flex flex-col gap-6">
              {['/img/info/comparativa.webp', '/img/info/datos_tecnicos.webp'].map((src, i) => (
                <div key={i} className="rounded-[3px] overflow-hidden" style={{ border: '1px solid var(--border-soft)' }}>
                  {/* eslint-disable-next-line @next/next/no-img-element */}
